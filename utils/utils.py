...
def page_config(layout = "centered"):
    st.set_page_config(
        page_title="Complex Topic Simplifier",
...
def template_end():
    with st.sidebar.expander("ℹ️ - About this App"):
        st.sidebar.markdown("This app uses Lyzr's Automata to simplified any complex topic in simpler manner for any type of audience")
